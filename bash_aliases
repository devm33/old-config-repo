...
alias cd-to-temp-da="cd /home/dev/digitalassent/prod-health/working-all/.working/patientpad/temp/"
alias cd-to-adserver-sql="cd /home/dev/digitalassent/prod-health/development/modules/com.digitalassent.adserver/scripts/deploymentsql"
...
alias nprompt="PS1='${Color_Off}${BGreen}\u${Blue}@${BGreen}`hostname -I | cut -c -15` ${BBlue}\w \n\$ ${Color_Off}'"
